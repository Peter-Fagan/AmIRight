...
class AnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create answer" do
    assert_difference('Answer.count') do
      post answers_url, params: { answer: { content: @answer.content, value: @answer.value } }
    end
  ...
  test "should update answer" do
    patch answer_url(@answer), params: { answer: { content: @answer.content, value: @answer.value } }
